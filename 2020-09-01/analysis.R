...
download.file("https://www.chp.gov.hk/files/pdf/building_list_eng_20200901.pdf", "../00_original/building_list_eng_20200901.pdf")
...
# "List of buildings with confirmed / probable cases visited from 2 days"
# from building_list_eng_20200901.pdf == pdflist[220]
# to current

for (i_file in 220:length(pdflist)){
