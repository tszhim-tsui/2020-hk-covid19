...
# download data file
download.file("https://www.chp.gov.hk/files/pdf/building_list_eng_20200731.pdf", "../00_original/building_list_eng_20200731.pdf")

# read pdf
current <- pdf_text("../00_original/building_list_eng_20200731.pdf")

# also get date in file name
currentdate <- stringr::str_extract("building_list_eng_20200731.pdf", "2020[0-9]+")
